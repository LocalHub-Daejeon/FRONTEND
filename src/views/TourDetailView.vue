...
const festivalStartDate = computed(() =>
  formatEventDate(tour.value?.eventstartdate, locale.value),
);
const festivalEndDate = computed(() =>
  formatEventDate(tour.value?.eventenddate, locale.value),
);
